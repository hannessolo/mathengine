...
class BinaryApplication implements Expression {
    ...
    public Expression differentiate(String x) {
        switch (op) {
            ...
            case MULTIPLY:
                return new BinaryApplication(ADD, new BinaryApplication(op, arg1.differentiate(x), arg2), new BinaryApplication(op, arg1, arg2.differentiate(x)));
            case DIVIDE:
                return new BinaryApplication(DIVIDE, new BinaryApplication(SUBTRACT,
                        new BinaryApplication(op, arg1.differentiate(x), arg2), new BinaryApplication(op, arg1, arg2.differentiate(x))),
